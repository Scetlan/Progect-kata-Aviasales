...
function Ticket() {
  ...
  // // const progressivelyLoadedTickets = useSelector(state => state.tickets.progressivelyLoadedTickets);
  // // const isReceivedFetchData = useSelector(state => state.tickets.isReceivedFetchData);
  ...
  //   if (loading === 'pending' || !isReceivedFetchData) {
  //     return (
  ...
  //   }
  //   if (progressivelyLoadedTickets.length === 0 && loading === 'fulfilled') {
