...
const ticketsSlice = createSlice({
  ...
  reducers: {
    ...
    setCheckBox: (state, action) => {
      ...
      const { stateCheckBox } = state; //checkBoxType
      state.stateCheckBox[key] = isActive;
      state.stateCheckBox.disabledAllCheckbox =
        stateCheckBox.noneCheckbox ||
        stateCheckBox.firstCheckbox ||
        stateCheckBox.secondCheckbox ||
        stateCheckBox.thirdCheckbox;
...
export const loadingTickets = createAsyncThunk(
  'ticketsSlice/loadingTickets',
  async (_, { getState }) => {
...
export const fetchTicketsSort = createAsyncThunk(
  'ticketsSlice/fetchTicketsSort',
  async (_, { getState }) => {
    const state = getState();
